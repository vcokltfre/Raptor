...
class LoggingFormats(BaseModel):
    ...
    INFRACTION_MUTE_REMOVE: str = "`[#(infraction_id)]` Mute has been removed for user #(infraction_member)"
    INFRACTION_BAN_REMOVE: str = "`[#(infraction_id)]` Ban has been removed for user #(infraction_member)"
    ...
    MEMBER_ROLES_ADD: str = ":key: #(member_name)##(member_dics) (`#(member_id)`) gained roles: #(roles)"
    MEMBER_ROLES_REMOVE: str = ":key: #(member_name)##(member_dics) (`#(member_id)`) lost roles: #(roles)"
    ...
    CHANNEL_DELETE: str = ":arrow_down: Channel #(channel_name) (`#(channel_id)`) was deleted"
    ...
    THREAD_DELETE: str = ":arrow_down: Thread #(thread_name) (`#(thread_id)`) was deleted"
    ...
    STICKER_CREATE: str = "Sticker was created (id: `#(sticker_id)`, name: `#(sticker_name)`)"
    STICKER_DELETE: str = "Sticker was created (id: `#(sticker_id)`, name: `#(sticker_name)`)"
